...
public class DimensionDataStorageMixin {
    ...
    private CompoundTag excavated_variants$readTagFromDisk(@Nullable DataFixTypes dataFixTypes, DataFixer fixer, CompoundTag tag, int version, int newVersion, Operation<CompoundTag> operation) {

...
public final class Ore {
    ...
    private @Nullable Map<ResourceKey<Block>, ResourceKey<Stone>> blocksBaked;
    ...
    private @Nullable Map<ResourceKey<Stone>, ResourceKey<Block>> blocksBakedInverse;
    private @Nullable Map<ResourceKey<Block>, ResourceKey<Stone>> generatingBlocks;
    ...
    public static class Builder {
        private @Nullable List<ResourceLocation> tags;
        private @Nullable Map<ResourceLocation, DetailedStone> blocks;
        private @Nullable Map<String, String> translations;
        private @Nullable Set<ResourceKey<GroundType>> types;
